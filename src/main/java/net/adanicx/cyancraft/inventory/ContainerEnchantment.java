package net.adanicx.cyancraft.inventory;
...
public class ContainerEnchantment extends Container {
	...
	public boolean canInteractWith(EntityPlayer player) {
		return world.getBlock(posX, posY, posZ) != CBlocks.enchantment_table ? false : player.getDistanceSq(posX + 0.5D, posY + 0.5D, posZ + 0.5D) <= 64.0D;
	}
