...
public class BlockChorusPlantRenderer extends BlockChorusFlowerRenderer {
	...
	public boolean renderWorldBlock(IBlockAccess world, int x, int y, int z, Block block, int modelId, RenderBlocks renderer) {
		...
		if (neighbourUp == CBlocks.chorus_flower || neighbourUp == Blocks.end_stone || neighbourUp == block) {
		...
		if (neighbourDown == CBlocks.chorus_flower || neighbourDown == Blocks.end_stone || neighbourDown == block) {
		...
		if (neighbourWest == CBlocks.chorus_flower || neighbourWest == Blocks.end_stone || neighbourWest == block) {
		...
		if (neighbourEast == CBlocks.chorus_flower || neighbourEast == Blocks.end_stone || neighbourEast == block) {
		...
		if (neighbourNorth == CBlocks.chorus_flower || neighbourNorth == Blocks.end_stone || neighbourNorth == block) {
		...
		if (neighbourSouth == CBlocks.chorus_flower || neighbourSouth == Blocks.end_stone || neighbourSouth == block) {
