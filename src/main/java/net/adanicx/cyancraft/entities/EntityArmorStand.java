...
public class EntityArmorStand extends EntityLiving{
	...
	public ItemStack getPickedResult(MovingObjectPosition target) {
		return new ItemStack(CItems.armor_stand);
	}
	...
	public boolean interact(EntityPlayer player) {
		if (worldObj.isRemote) {
			CyancraftMod.networkWrapper.sendToServer(new ArmorStandInteractMessage(worldObj.provider.dimensionId, this, player));
			return true;
		}
		return false;
	}
	...
	private void dropBlock() {
		entityDropItem(new ItemStack(CItems.armor_stand), 0.0F);
		dropequipment();
	}
