...
import net.adanicx.cyancraft.entities.Rotations;
...
public class ItemArmorStand extends Item implements IConfigurable {
	...
	public ItemArmorStand() {
		...
		setUnlocalizedName(Utilities.getUnlocalizedName("wooden_armorstand"));
		setCreativeTab(CyancraftMod.enableArmorStand ? CyancraftMod.creativeTab : null);
	}
	...
	public boolean isEnabled() {
		return CyancraftMod.enableArmorStand;
	}
}
