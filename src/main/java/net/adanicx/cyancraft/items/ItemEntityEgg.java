...
import net.adanicx.cyancraft.dispenser.DispenserBehaviorSpawnEgg;
import net.adanicx.cyancraft.entities.ModEntityList;
import net.adanicx.cyancraft.entities.ModEntityList.EntityData;
...
public class ItemEntityEgg extends Item{
	...
	public ItemEntityEgg() {
		...
		setUnlocalizedName(Utilities.getUnlocalizedName("entity_egg"));
		BlockDispenser.dispenseBehaviorRegistry.putObject(this, new DispenserBehaviorSpawnEgg());
	}
