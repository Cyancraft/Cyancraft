...
import net.adanicx.cyancraft.dispenser.DispenserBehaviorLingeringPotion;
...
public class LingeringPotion  extends ItemPotion implements IConfigurable {
	...
	public LingeringPotion() {
		...
		setUnlocalizedName(Utilities.getUnlocalizedName("lingering_potion"));
		setCreativeTab(CyancraftMod.enableLingeringPotions ? CyancraftMod.creativeTab : null);

		if (CyancraftMod.enableLingeringPotions)
			BlockDispenser.dispenseBehaviorRegistry.putObject(this, new DispenserBehaviorLingeringPotion());
	}
