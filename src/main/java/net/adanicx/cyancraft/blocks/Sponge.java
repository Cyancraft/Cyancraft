...
import net.adanicx.cyancraft.world.WorldCoord;
...
public class Sponge extends BlockGeneric implements IConfigurable {
	...
	public Sponge() {
		...
		setBlockName(Utilities.getUnlocalizedName("sponge"));
		setCreativeTab(CyancraftMod.enableSponge ? CyancraftMod.creativeTab : null);
	}
	...
	public boolean isEnabled() {
		return CyancraftMod.enableSponge;
	}
}