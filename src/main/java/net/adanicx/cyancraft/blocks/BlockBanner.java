...
import net.adanicx.cyancraft.items.block.ItemBanner;
...
public class BlockBanner extends BlockContainer implements ISubBlocksBlock, IConfigurable {
	...
	public BlockBanner() {
		...
		setBlockName(Utilities.getUnlocalizedName("banner"));
		setCreativeTab(CyancraftMod.enableBanners ? CyancraftMod.creativeTab : null);
	...
	public void setBlockBoundsBasedOnState(IBlockAccess world, int x, int y, int z) {
		TileEntityBanner tile = Utilities.getTileEntity(world, x, y, z, TileEntityBanner.class);
		if (tile == null)
			return;
	...
	public ItemStack getPickBlock(MovingObjectPosition target, World world, int x, int y, int z, EntityPlayer player) {
		TileEntityBanner banner = Utilities.getTileEntity(world, x, y, z, TileEntityBanner.class);
		if (banner != null)
	...
	public boolean isEnabled() {
		return CyancraftMod.enableBanners;
	}
